...
const schemaStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS "StationOwner" ("id" TEXT NOT NULL, "email" TEXT NOT NULL, "password" TEXT NOT NULL, "name" TEXT NOT NULL, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "StationOwner_pkey" PRIMARY KEY ("id"));`,
...
const seedStatements = [
  `INSERT INTO "StationOwner" (id, email, password, name, "createdAt", "updatedAt") VALUES ('owner1', 'joao@posto.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Joao Silva', NOW(), NOW()), ('owner2', 'maria@posto.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Maria Santos', NOW(), NOW()) ON CONFLICT (id) DO NOTHING;`,
